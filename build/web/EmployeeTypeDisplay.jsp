<%-- 
    Document   : EmployeeTypeDisplay
    Created on : Nov 21, 2016, 4:00:11 PM
    Author     : nsg
--%>
...
<s:form action="empTypeEnroll">
      <s:submit value="Add Employee Type" cssClass="btn btn-primary activated1"/>
  </s:form>
 </div>
...
<s:iterator value="emp" status="rowstatus">
    <tr>
        ...
        <td><s:property value="empTypeId"></s:property></td>
        <td><s:property value="description"></s:property></td>
        <td><a href="empEdit?id=<s:property value='empTypeId' /> " > <img src="images/edit.png" alt="images" /></a></td>
        <td><a href="empDelete?id=<s:property value='empTypeId' /> " onclick="return confirm('Are you Sure you want to delete?')"> <img src="images/delete.png" alt="images" /></a></td>
</tr>
</s:iterator>
</table>
</div>
