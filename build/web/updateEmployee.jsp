<%-- 
    ...
    Created on : Nov 21, 2016, 6:25:42 PM
    Author     : nsg
--%>
...
<div class="container">
  <h2 class="text-center text-primary">Employee Type</h2>
    <div class="clear">&#x00A0;</div>
        <div class="clear">&#x00A0;</div>
     <s:form action="empUpdate"  enctype="multipart/form-data" method="post" >          
    <table>
         <s:iterator value="emp">
        <tr>
            <td><s:textfield id="i" name="empf.empTypeId" label="Employee Type Id" readonly="true" value="%{empTypeId}" cssClass="form-control form-group" autofocus="autofocus" size="90"></s:textfield></td> 
            <td><s:textfield id="i" name="empf.description" label="Description"  value="%{description}" cssClass="form-control form-group"  /></td>
      ...
      <s:submit  value="Update"  cssClass="btn btn-default" align="center" ></s:submit>
          ...
          <div class="col-sm-6 text-center"> 
          <button type="button" class="btn btn-default" ><a href="EmpTypeDisplay" style="text-decoration:none; color:black">Cancel</a></button>
          </div>
            </div> 
    </s:form>
    </center>
